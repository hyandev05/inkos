...
// 标签在调用时通过 tr() 解析语言，所以这里存 zh/en/vi 而不是最终字符串。
const SERVICE_QUICK_LINKS: Record<string, ReadonlyArray<{ zh: string; en: string; vi: string; href: string }>> = {
  kimicode: [
    { zh: "官网", en: "Website", vi: "Website", href: "https://www.kimi.com?aff=inkos" },
  ],
  kimiCodingPlan: [
    { zh: "官网", en: "Website", vi: "Website", href: "https://www.kimi.com?aff=inkos" },
  ],
  kkaiapi: [
    { zh: "官网", en: "Website", vi: "Website", href: "https://kkaiapi.com/" },
  ...
  moonshot: [
    { zh: "开放平台", en: "Developer platform", vi: "Nền tảng phát triển", href: "https://platform.kimi.com?aff=inkos" },
  ],
  openrouter: [
...
export function ServiceQuickLinks({
  ...
  return (
    ...
    >
      {!compact && <span className="mr-0.5">{tr("配置入口", "Quick links", "Đường dẫn cấu hình")}</span>}
      {links.map((link) => (
        <a
          key={link.href}
          href={link.href}
